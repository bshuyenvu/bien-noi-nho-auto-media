...
const path=await writeShotCraftRenderManifest({
  ...
  motion:'light',
  scenes:[
    {imageIndex:0,startRatio:0,endRatio:.4,shotRecipe:'slow-push',transition:'cut',holdRatio:.14,energy:.28,sourceCredit:'WHO'},
...
console.log('ShotCraft render manifest smoke OK',JSON.stringify({path,schema:manifest.schema,scenes:manifest.scenes.length}));

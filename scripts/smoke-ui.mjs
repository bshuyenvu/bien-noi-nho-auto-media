...
for(const requiredJs of ['MỞ REVIEW Y KHOA','pipeline-review-summary','✓ ACCEPT & TIẾP TỤC','Research đã PASS. Hãy đối chiếu Evidence Pack','prepareContentStudioAutodraft','/api/content-studio-v2/wizard/autodraft']){

...
const required=[
  ...
  'TIN NÓNG','previewScenesBtn','LỊCH SỬ RENDER','CONTENT STUDIO V2 • PROJECT PIPELINE','contentStudioV2Panel','contentStudioProjectSelect','contentStudioSceneList','contentStudioActionBtn','contentStudioActionNote',

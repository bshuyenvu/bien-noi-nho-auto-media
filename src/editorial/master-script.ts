...
export interface MasterStory{hook:string;body:string;closing:string;script:string;claimIds:string[];versions:Record<string,ScriptVersion>;recommendedSeconds:45|60|90|120}

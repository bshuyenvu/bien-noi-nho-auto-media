...
app.use('/api',(q,r)=>r.status(404).json({error:`API endpoint không tồn tại: ${q.method} ${q.originalUrl}`,code:'API_NOT_FOUND',version:'3.6.5'}));
...
app.listen(PORT,'0.0.0.0',()=>console.log(`Auto Media V3.6.5 API Sync running on :${PORT}`));

...
const app=express();app.use(express.json());app.use('/output',express.static('output'));app.use(express.static('public'));
...
const drafts:Draft[]=[];
app.get('/health',(_q,r)=>r.json({ok:true,service:'bien-noi-nho-auto-media',version:'0.5.0'}));
...
app.listen(PORT,'0.0.0.0',()=>console.log(`Auto Media V0.5 running on :${PORT}`));

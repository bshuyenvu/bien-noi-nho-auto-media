...
app.get('/health',(_q,r)=>r.json({ok:true,service:'bien-noi-nho-auto-media',version:'1.3.0',mode:'self-hosted',storage:'sqlite'}));
...
app.get('/',(_q,r)=>r.sendFile('app.html',{root:'public'}));app.listen(PORT,'0.0.0.0',()=>console.log(`Auto Media V1.3 self-hosted + SQLite running on :${PORT}`));

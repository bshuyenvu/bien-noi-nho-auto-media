...
function templateOverlay(template:VideoTemplate,label:string,headlineFile:string,sourceFile?:string,srtPath?:string,tickerFile?:string,tickerSpeed=85){
 ...
 const ticker=tickerFile?[`drawbox=x=55:y=1560:w=970:h=48:color=0x061426@0.96:t=fill`,`drawbox=x=55:y=1560:w=125:h=48:color=0x075bc7:t=fill`,`drawtext=fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf:text='TIN':fontcolor=white:fontsize=18:x=92:y=1574`,`drawtext=fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf:textfile='${escPath(tickerFile)}':reload=0:fontcolor=white:fontsize=18:x='180+w-mod(t*${tickerSpeed},w+text_w)':y=1574`].join(','):'null';

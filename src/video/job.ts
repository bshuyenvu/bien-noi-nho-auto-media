...
import { renderNewsVideo, type VideoTemplate, type MotionLevel } from './ffmpeg.js';
...
export function enqueueRender(input:{draftId:string;text:string;headline:string;source?:string;breaking?:boolean;voice?:VoiceId;voiceRate?:string;imageUrl?:string;template?:VideoTemplate;motion?:MotionLevel}){
